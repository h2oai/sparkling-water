...
batchFile <- "/opt/sparkling-water/tests/initTest.R"
...
config["sparklyr.shell.files"] <- batchFile
spark_submit(master = master, file = batchFile, config = config, spark_home = sparkHome)
