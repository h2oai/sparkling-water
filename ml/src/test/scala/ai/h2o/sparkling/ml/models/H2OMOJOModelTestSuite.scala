...
class H2OMOJOModelTestSuite extends FunSuite with SharedH2OTestContext with Matchers {
  ...
  test("BooleanColumn as String for mojo predictions") {
    val mojo = H2OMOJOModel.createFromMojo(
      this.getClass.getClassLoader.getResource("airlines_boolean.mojo").toString,
  ...
  private def savedBinomialModel() = {
    val mojo = H2OMOJOModel.createFromMojo(
      this.getClass.getClassLoader.getResource("binom_model_prostate.mojo").toString,
  ...
  private def savedRegressionModel() = {
    val mojo = H2OMOJOModel.createFromMojo(
      this.getClass.getClassLoader.getResource("regre_model_prostate.mojo").toString,
  ...
  private def savedMultinomialModel() = {
    val mojo = H2OMOJOModel.createFromMojo(
      this.getClass.getClassLoader.getResource("multi_model_iris.mojo").toString,
  ...
  private def savedDeepLearningModel() = {
    val mojo = H2OMOJOModel.createFromMojo(
      this.getClass.getClassLoader.getResource("deep_learning_prostate.mojo").toString,
