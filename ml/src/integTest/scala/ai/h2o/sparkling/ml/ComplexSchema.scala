...
case object ComplexSchema extends TestUtils.SchemaHolder {
  @transient lazy val schema: StructType = {
    StructType(
      Seq(
        ...
        StructField(
          "field_5V460N466V",
          ArrayType(StructType(Seq(StructField("field_8QIMSA", LongType), StructField("field_NKFT9M5", StringType))))),
        StructField(
          "field_1CGUTYW",
          ArrayType(StructType(Seq(
            ...
            StructField(
              "field_CN2PQ748U1OBJ",
              ArrayType(StructType(
                Seq(StructField("field_HKTXKOYLO6RFQ9H", LongType), StructField("field_V35TZP", LongType))))),
