...
To obtain the stage results, please first make sure to set \texttt{withStageResults} on your MOJO settings object.
The stage results for regression and anomaly detection problems
