...
pipeline{
    ...
    parameters {
        ...
        booleanParam(name: 'buildAgainstH2OBranch', defaultValue: true, description: 'By default, Sparkling Water is built with the included H2O. This option may be used to force build to use specific H2O branch against which Sparkling Water is built.')
