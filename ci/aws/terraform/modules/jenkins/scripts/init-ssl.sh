...
certbot certonly -d $PUBLIC_HOSTNAME --non-interactive --agree-tos --standalone -m support@h2o.ai
cp /etc/letsencrypt/live/$PUBLIC_HOSTNAME/privkey.pem /etc/ssl/private/my-key.pem
cp /etc/letsencrypt/live/$PUBLIC_HOSTNAME/fullchain.pem /etc/ssl/certs/my-cert.pem
