...
import ai.h2o.sparkling.ml.models.{H2OMOJOModelUtils, H2OMOJOReadable}
...
@Deprecated
object H2OMOJOModel extends H2OMOJOReadable[ai.h2o.sparkling.ml.models.H2OMOJOModel] with H2OMOJOLoader[H2OMOJOModel] with H2OMOJOModelUtils {
