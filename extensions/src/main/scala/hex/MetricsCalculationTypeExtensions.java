...
public class MetricsCalculationTypeExtensions implements TypeMapExtension {
    ...
    public String[] getBoostrapClasses() {
        String[] result = Arrays.copyOf(MODEL_BUILDER_CLASSES, MODEL_BUILDER_CLASSES.length + SCHEMA_CLASSES.length);
        System.arraycopy(SCHEMA_CLASSES, 0, result, MODEL_BUILDER_CLASSES.length, SCHEMA_CLASSES.length);
        return result;
    }
}
