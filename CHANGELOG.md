...
##v1.5.15 (2016-07-06)
  - Bug fixes
    ...
    - [SW-154](https://0xdata.atlassian.net/browse/SW-154) - Network mask can be specified separately for client and node H2O instances
  ...
  - Improvements
    ...
    - [SW-149](https://0xdata.atlassian.net/browse/SW-149) - Create method H2OContext.get and use it in places where H2OContext should be already running
