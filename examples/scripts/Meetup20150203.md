...
### For Sparkling Water part
 ...
 - [Sparkling Water 0.2.8-71](http://h2o-release.s3.amazonaws.com/sparkling-water/master/71/index.html)
...
```
unzip sparkling-water-0.2.8-71.zip
cd sparkling-water-0.2.8-71
```
