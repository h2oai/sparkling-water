...
Please see `Running Sparkling Water Examples <http://docs.h2o.ai/sparkling-water/3.2/latest-stable/doc/devel/running_examples.html>`__ for more information how to build
and run examples.

Configuring Sparkling Water Variables
-------------------------------------

Please see `Available Sparkling Water Configuration Properties <http://docs.h2o.ai/sparkling-water/3.2/latest-stable/doc/configuration/configuration_properties.html>`__ for
...
.. |CityBikeSharingDemo| replace:: `CityBikeSharingDemo <src/main/scala/ai/h2o/sparkling/examples/CityBikeSharingDemo.scala>`__
