...
Please see `Running Sparkling Water Examples <http://docs.h2o.ai/sparkling-water/3.3/latest-stable/doc/devel/running_examples.html>`__ for more information how to build
and run examples.

Configuring Sparkling Water Variables
-------------------------------------

Please see `Available Sparkling Water Configuration Properties <http://docs.h2o.ai/sparkling-water/3.3/latest-stable/doc/configuration/configuration_properties.html>`__ for
