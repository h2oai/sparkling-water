...
or you can create the Kerberos ticket in before hand using ``kinit`` and call just
...
``spark.ext.h2o.external.kerberos.principal`` and ``spark.ext.h2o.external.kerberos.keytab`` correspondigly. These options
