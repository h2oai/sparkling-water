...
3.  Upload PySparkling Library as a library from PiPy
    ...
    In order to create the Python library in Databricks, go to **Libraries**, select **Upload Python Egg or Pipy** and insert ``h2o_pysparkling_2.1`` for the latest PySparkling for Spark 2.1.
