...
.. code:: bash
    ...
    $SPARK_HOME/bin/spark-submit --repositories http://dl.bintray.com/komiya-atsushi/maven --packages ai.h2o:sparkling-water-package_2.11:SUBST_SW_VERSION --class org.apache.spark.examples.h2o.CraigslistJobTitlesStreamingApp /dev/null
...
.. code:: bash
    ...
    $SPARK_HOME/bin/spark-shell --repositories http://dl.bintray.com/komiya-atsushi/maven --packages ai.h2o:sparkling-water-package_2.11:SUBST_SW_VERSION

The same command works for Python programs:

.. code:: bash

    $SPARK_HOME/bin/spark-submit --repositories http://dl.bintray.com/komiya-atsushi/maven --packages ai.h2o:sparkling-water-package_2.11:SUBST_SW_VERSION example.py
