...
When training algorihtm using Sparkling Water API, Sparkling Water always produces ``H2OMOJOModel``. It is however also possible
to import existing MOJO into Sparkling Water ecosystem from H2O-3.
