...
v3.32.0.1-1 (2020-04-23)
------------------------
Downloads:
   - for Spark 2.1: `http://h2o-release.s3.amazonaws.com/sparkling-water/spark-2.1/jh-SW-2160/3.32.0.1-1-2.1/index.html <http://h2o-release.s3.amazonaws.com/sparkling-water/spark-2.1/jh-SW-2160/3.32.0.1-1-2.1/index.html>`__
   - for Spark 2.2: `http://h2o-release.s3.amazonaws.com/sparkling-water/spark-2.2/jh-SW-2160/3.32.0.1-1-2.2/index.html <http://h2o-release.s3.amazonaws.com/sparkling-water/spark-2.2/jh-SW-2160/3.32.0.1-1-2.2/index.html>`__
   - for Spark 2.3: `http://h2o-release.s3.amazonaws.com/sparkling-water/spark-2.3/jh-SW-2160/3.32.0.1-1-2.3/index.html <http://h2o-release.s3.amazonaws.com/sparkling-water/spark-2.3/jh-SW-2160/3.32.0.1-1-2.3/index.html>`__
   - for Spark 2.4: `http://h2o-release.s3.amazonaws.com/sparkling-water/spark-2.4/jh-SW-2160/3.32.0.1-1-2.4/index.html <http://h2o-release.s3.amazonaws.com/sparkling-water/spark-2.4/jh-SW-2160/3.32.0.1-1-2.4/index.html>`__

-  New Feature
        
   -  `SW-56 <https://0xdata.atlassian.net/browse/SW-56>`__ - Create Scala API to upload local file
   -  `SW-1184 <https://0xdata.atlassian.net/browse/SW-1184>`__ - Add Support for Stacked Ensembles to Sparkling Water pipelines
   -  `SW-1652 <https://0xdata.atlassian.net/browse/SW-1652>`__ - Expose H2O SVM into Sparkling Water Algorithm API
   -  `SW-1926 <https://0xdata.atlassian.net/browse/SW-1926>`__ - Support for Spark pipelines in RSparkling
   -  `SW-2029 <https://0xdata.atlassian.net/browse/SW-2029>`__ - Add H2O GLRM to Algo API
   -  `SW-2030 <https://0xdata.atlassian.net/browse/SW-2030>`__ - Add H2O PCA to Algo API
   -  `SW-2031 <https://0xdata.atlassian.net/browse/SW-2031>`__ - Add H2O Word2vec to Algo API
                
-  Improvement
        
   -  `SW-379 <https://0xdata.atlassian.net/browse/SW-379>`__ - Enable PAM authentication in SW
   -  `SW-1192 <https://0xdata.atlassian.net/browse/SW-1192>`__ - Better handling of a Spark SQL logic leading to execution of broadcast joins
   -  `SW-1315 <https://0xdata.atlassian.net/browse/SW-1315>`__ - Expose H2O W2V in SW
   ...
   -  `SW-1847 <https://0xdata.atlassian.net/browse/SW-1847>`__ - Automatically document Sparkling Water Algo API
   -  `SW-1971 <https://0xdata.atlassian.net/browse/SW-1971>`__ - Remove deprecated method H2OContext.getOrCreate with sparkSession or SparkContext argument
   -  `SW-2001 <https://0xdata.atlassian.net/browse/SW-2001>`__ - Experiment with sending full chunks to H2O in spark in external backend
   -  `SW-2019 <https://0xdata.atlassian.net/browse/SW-2019>`__ - Experiment with auto cluster start on Kubernetes
   ...
   -  `SW-2074 <https://0xdata.atlassian.net/browse/SW-2074>`__ - Remove Implicit Switch to External Backend when H2OConf.setH2OCluster is Called
   -  `SW-2083 <https://0xdata.atlassian.net/browse/SW-2083>`__ - Remove deprecated hex.ModelUtils
   -  `SW-2085 <https://0xdata.atlassian.net/browse/SW-2085>`__ - Remove deprecated DeepLearningSupport and GBMSupport
   -  `SW-2088 <https://0xdata.atlassian.net/browse/SW-2088>`__ - Remove deprecated MetricsSupport
   -  `SW-2090 <https://0xdata.atlassian.net/browse/SW-2090>`__ - Set log level via rest API
   -  `SW-2091 <https://0xdata.atlassian.net/browse/SW-2091>`__ - Add support to import hive table over rest in scala
   -  `SW-2099 <https://0xdata.atlassian.net/browse/SW-2099>`__ - Switch the option from SW-2098 to do not start client by default
   -  `SW-2100 <https://0xdata.atlassian.net/browse/SW-2100>`__ - Merge internal &amp; external testing pipelines together
   -  `SW-2101 <https://0xdata.atlassian.net/browse/SW-2101>`__ - Deprecate client related configuration in Python and R
   -  `SW-2102 <https://0xdata.atlassian.net/browse/SW-2102>`__ - Remove deprecated client related configuration in R and Python
   -  `SW-2103 <https://0xdata.atlassian.net/browse/SW-2103>`__ - In Spark local mode in internal backend, notify user that from now on, the node related properties should be setup, instead the client related ones
   -  `SW-2104 <https://0xdata.atlassian.net/browse/SW-2104>`__ - In Spark local mode in internal backend, use node related properties instead of the client ones
   -  `SW-2107 <https://0xdata.atlassian.net/browse/SW-2107>`__ - Ensure all core unit &amp; integtTets tests are run without client
   -  `SW-2128 <https://0xdata.atlassian.net/browse/SW-2128>`__ - Remove deprecated allStringColumnsToCategorical
   -  `SW-2129 <https://0xdata.atlassian.net/browse/SW-2129>`__ - Use node options intead of client options in case of local mode, internal backend( remove deprecation introduced by SW-2103)
   -  `SW-2136 <https://0xdata.atlassian.net/browse/SW-2136>`__ - Remove deprecated JoinSupport
   -  `SW-2137 <https://0xdata.atlassian.net/browse/SW-2137>`__ - Be able to represent data in H2OFrame
   -  `SW-2162 <https://0xdata.atlassian.net/browse/SW-2162>`__ - In GridSearch remove support for passing arguments with h2o name format
   -  `SW-2180 <https://0xdata.atlassian.net/browse/SW-2180>`__ - Remove deprecated setH2OClientLogLevel and setH2ONodeLogLevel method
   -  `SW-2183 <https://0xdata.atlassian.net/browse/SW-2183>`__ - Always produce probabilities in prediction as probabilitiesCol
                
-  Engineering Story
        
   -  `SW-2134 <https://0xdata.atlassian.net/browse/SW-2134>`__ - Remove deprecated H2OFrameSupport
   -  `SW-2140 <https://0xdata.atlassian.net/browse/SW-2140>`__ - Remove deprecated model serialization support
