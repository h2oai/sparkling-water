...
~~~~~~~~~~~~~~~~~~~~~
In case of installation from CRAN, the typical ``install.packages("h2o", "3.22.0.2")`` command can be used. Please note
...
of the H2O version name and number. Example: `http://h2o-release.s3.amazonaws.com/h2o/rel-xia/2/R`

.. code:: r

   # Download, install, and initialize the H2O package for R.
   # In this case we are using rel-xia 2 (3.22.0.2)
...
1. Download the Sparkling Water jar of your choice based on the integration table above.
   To do this go to the following link where ``[SW Major Version]`` is the major version of Sparkling Water you wish to use, i.e., ``2.2`` and ``[SW Minor Version]`` is the minor version of Sparkling Water you wish to use, i.e., ``29``,
