...
1. Download `Spark <https://spark.apache.org/downloads.html>`__ (Pick any supported minor version for Spark 2.3)
2. Unzip Spark files
...
from the link `http://h2o-release.s3.amazonaws.com/sparkling-water/rel-2.3/31/R` as:

.. code:: r

   # Download, install, and initialize the RSparkling
   install.packages("rsparkling", type = "source", repos = "http://h2o-release.s3.amazonaws.com/sparkling-water/rel-2.3/31/R")
...
1. Download the Sparkling Water jar of your choice based on the integration table above.
   To do this go to the following link where ``[SW Major Version]`` is the major version of Sparkling Water you wish to use, i.e., ``2.3`` and ``[SW Minor Version]`` is the minor version of Sparkling Water you wish to use, i.e., ``31``,
