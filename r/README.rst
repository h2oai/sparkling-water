...
1. Download the Sparkling Water jar of your choice based on the integration table above.
   To do this go to the following link where ``[SW Major Version]`` is the major version of Sparkling Water you wish to use, i.e., ``2.2`` and ``[SW Minor Version]`` is the minor version of Sparkling Water you wish to use, i.e., ``35``,
