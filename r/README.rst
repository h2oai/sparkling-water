...
~~~~~~~~~~~~~~~~~~~~~~~~~~
**RSparkling SUBST_PROJECT_VERSION** is built for 2.2.
...
1. Download `Spark <https://spark.apache.org/downloads.html>`__ (Pick any supported minor version for Spark 2.2)
2. Unzip Spark files
...
of the H2O version name and number. Example: `http://h2o-release.s3.amazonaws.com/h2o/rel-yates/4/R`

.. code:: r

   # Download, install, and initialize the H2O package for R.
   # In this case we are using rel-yates 4 (3.24.0.4)
...
from the link `http://h2o-release.s3.amazonaws.com/sparkling-water/rel-2.2/42/R` as:

.. code:: r

   # Download, install, and initialize the RSparkling
   install.packages("rsparkling", type = "source", repos = "http://h2o-release.s3.amazonaws.com/sparkling-water/rel-2.2/42/R")
...
1. Download the Sparkling Water jar of your choice based on the integration table above.
   To do this go to the following link where ``[SW Major Version]`` is the major version of Sparkling Water you wish to use, i.e., ``2.2`` and ``[SW Minor Version]`` is the minor version of Sparkling Water you wish to use, i.e., ``42``,
