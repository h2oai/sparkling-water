...
~~~~~~~~~~~~~~~~~~~~~~~~~~
**RSparkling SUBST_PROJECT_VERSION** is built for 2.4.

The following command will install Spark 2.4.3:
...
1. Download `Spark <https://spark.apache.org/downloads.html>`__ (Pick any supported minor version for Spark 2.4)
2. Unzip Spark files
...
from the link `http://h2o-release.s3.amazonaws.com/sparkling-water/rel-2.4/13/R` as:
...
1. Download the Sparkling Water jar of your choice based on the integration table above.
   To do this go to the following link where ``[SW Major Version]`` is the major version of Sparkling Water you wish to use, i.e., ``2.4`` and ``[SW Minor Version]`` is the minor version of Sparkling Water you wish to use, i.e., ``13``,
