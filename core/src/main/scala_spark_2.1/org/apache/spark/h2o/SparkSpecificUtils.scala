...
import org.apache.spark.h2o.ui.{SparklingWaterFlowUITab, SparklingWaterListener, SparklingWaterUITab}
...
object SparkSpecificUtils extends CrossSparkUtils {
  override def headerSparkPage(request: HttpServletRequest,
                               title: String,
                               content: => Seq[Node],
