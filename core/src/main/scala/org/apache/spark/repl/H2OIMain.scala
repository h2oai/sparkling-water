...
@DeveloperApi
  ...
  */
  ...
  private[repl] lazy val reporter: ConsoleReporter = new H2OIMain.ReplReporter(this)
  ...
  private lazy val isettings = new H2OISettings(this)
...
object H2OIMain {
  ...
  class ReplReporter(intp: H2OIMain) extends ConsoleReporter(intp.settings, null, new ReplStrippingWriter(intp)) {
