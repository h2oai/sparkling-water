...
with open(path.join(here, 'README_a.rst'), encoding='utf-8') as f:
...
setup(
    ...
    install_requires=['requests', 'tabulate', 'future', 'colorama>=0.3.8', 'pyspark>=SUBST_SPARK_MAJOR_VERSION.0,<=SUBST_SPARK_VERSION'],
